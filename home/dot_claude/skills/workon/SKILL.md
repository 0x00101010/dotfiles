---
name: workon
description: Pick up a task from any source, auto-escalate to ultrathink subagents or parallel swarms when warranted, then execute.
---
...
## 3. Mode detection (auto, silent unless one fires)
...
## 6. When user says done (never auto)
